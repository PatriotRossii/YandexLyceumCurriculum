...
cities = {
    'москва': ['1030494/05e9481ddd1de46627bd',
               '1521359/25a31a218d66e5099dfd'],
    'нью-йорк': ['965417/c2f550020a2b33022e57',
                 '1652229/aacd4ac81b136ad45047'],
    'париж': ["1652229/00279451412c693d3c86",
              '965417/f657527ad32e5f162bc8']
}
countries = {
    "Россия": ["москва"],
    "США": ["нью-йорк"],
...
def handle_dialog(res, req):
    ...
    if req['request']['original_utterance'].lower() == "помощь":
        res['response']['text'] = "Привет! Моя задача - играть с вами в игру 'Угадай город'. Я даю вам фотографии " \
                                  "различных городов, а вы должны угадать, как они называются."
        return
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if not sessionStorage[user_id]['game_started']:
            ...
            if 'да' in req['request']['nlu']['tokens']:
                ...
                res['end_session'] = True
            elif req['request']['original_utterance'].lower() == 'покажи город на карте':
                res['response']['text'] = f"Как изволите!"
                return
            else:
...
def play_game(res, req):
    ...
    if attempt == 1:
        ...
        if city in sessionStorage[user_id]['guessed_cities']:
            if get_country_entity(req).lower() == country.lower():
                res['response']['text'] = 'Правильно! Сыграем еще?'
            else:
                res['response']['text'] = f"Неправильно! Этот город находится в стране {country}. Сыграем еще?"
            res['response']['buttons'] += [
                {
